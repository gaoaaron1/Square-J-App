...
import com.sqj.cpsc.R;
import com.sqj.cpsc.model.AllCategoryModel;

import java.util.List;

public class EveryItemAdapter extends RecyclerView.Adapter<EveryItemAdapter.AllCategoryViewHolder> {

    Context context;
    List<AllCategoryModel> categoryList;

    public EveryItemAdapter(Context context, List<AllCategoryModel> categoryList) {
