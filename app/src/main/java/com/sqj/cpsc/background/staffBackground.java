...
import com.sqj.cpsc.StaffActivity;
...
public class staffBackground extends AsyncTask <String, Void,String> {
    ...
    public staffBackground(Context context)
    {
    ...
    protected void onPostExecute(String s) {
        ...
        if(s.contains("login successful"))
        {
            ...
            intent_name.setClass(context.getApplicationContext(), StaffActivity.class);
