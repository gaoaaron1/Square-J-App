...
import com.sqj.cpsc.adapter.EveryItemAdapter;
...
public class AllCategory extends AppCompatActivity {
    ...
    EveryItemAdapter allCategoryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Adding the data for every item.
    ...
    private void setCategoryRecycler(List<AllCategoryModel> allcategoryModelList) {
        ...
        allCategoryAdapter = new EveryItemAdapter(this,allcategoryModelList);
